...
Test Teardown    Realizar o test teardown    TEST_SETUP_FALHOU    CT0002    Test-2  # Define a palavra-chave de teardown e seus argumentos
...
Test-1
    ...
    Inserir no campo "Username" o username do usuario     123    # Insere o nome de usuário no campo de login
